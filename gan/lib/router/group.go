...
type RegisterFunc func(gin.IRouter)
...
// execRegister 注册子路由
func (g *Group) execRegister(routerGroup gin.IRouter) {
...
func (g *Group) mountSubGroup(parentRouterGroup gin.IRouter) {
